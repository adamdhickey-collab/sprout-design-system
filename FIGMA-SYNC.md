...
- Fonts: BigCaslonForCargill / HelveticaNow are licensed and not installed in the RBA
  Figma org. Stand-ins: **Baskervville** for the serif (closest available face to the
  Big Caslon display style — Baskerville is Caslon's direct historical successor),
  **Inter** for the sans (noted in every text style description). Swap when the real
  fonts are installed org-wide.
